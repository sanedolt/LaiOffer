...
//        for (int k = l; k <= r; k++) helper[k] = data[k];
//        int i = l, j = m + 1, k = l;
//        while (i <= m && j <= r)
...
//        List<T> helper = new ArrayList<>(list);
//        mergeSort(list, helper, 0, list.size() - 1);
//        return list;
//    }
//
//    private static <T extends Comparable<? super T>> void mergeSort(List<T> list, List<T> helper, int l, int r) {
//        if (l == r) return;
//        int m = l + (r - l) / 2;
//        mergeSort(list, helper, l, m);
//        mergeSort(list, helper, m + 1, r);
//        merge(list, helper, l, m, r);
//    }
//
//    private static <T extends Comparable<? super T>> void merge(List<T> list, List<T> helper, int l, int m, int r) {
//        for (int k = l; k <= r; k++) helper.set(k, list.get(k));
//        int i = l, j = m + 1, k = l;
//        while (i <= m && j <= r)
//            list.set(k++, helper.get(i).compareTo(helper.get(j)) < 0 ? helper.get(i++) : helper.get(j++));
//        while (i <= m)
...
//        if (list == null || list.size() <= 1) return list;
//        List<T> helper = new ArrayList<>(list);
//        mergeSort(list, helper, 0, list.size() - 1, comparator);
//        return list;
//    }
//
//    private static <T> void mergeSort(List<T> list, List<T> helper, int l, int r, Comparator<T> comparator) {
//        if (l == r) return;
//        int m = l + (r - l) / 2;
//        mergeSort(list, helper, l, m, comparator);
//        mergeSort(list, helper, m + 1, r, comparator);
//        merge(list, helper, l, m, r, comparator);
//    }
//
//    private static <T> void merge(List<T> list, List<T> helper, int l, int m, int r, Comparator<T> comparator) {
//        for (int k = l; k <= r; k++) helper.set(k, list.get(k));
//        int i = l, j = m + 1, k = l;
//        while (i <= m && j <= r)
//            list.set(k++, comparator.compare(helper.get(i), helper.get(j)) < 0 ? helper.get(i++) : helper.get(j++));
//        while (i <= m)
//            list.set(k++, helper.get(i++));
//    }
